...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 收藏记录 <span class="c-gray en">&gt;</span> 收藏教师列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20">  <span class="r">共有数据：<strong>${userCollectTeacherList.size() }</strong> 条</span> </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				...
				<th width="100">性别</th>
				<th width="200">头像</th>
				<th width="200">教师姓名</th>
				<th width="250">教师照片</th>
				<th >教师简介</th>
			</tr>
		</thead>
		<tbody>
			<c:forEach items="${userCollectTeacherList }" var="userCollectTeacher">
				<tr class="text-c">
					<th>${userCollectTeacher.userWechat.nickname }</th>
					<td>
						<c:choose>
							<c:when test="${userCollectTeacher.userWechat.sex eq 1 }">男</c:when>
							<c:otherwise>女</c:otherwise>
						</c:choose>
					</td>
					<td><img width="150" height="130" class="picture-thumb" src="${userCollectTeacher.userWechat.headimgurl }"></td>
					
					<th>${userCollectTeacher.teacher.teacherName }</th>
					<td><img width="150" height="130" class="picture-thumb" src="http://bdpak.cn:8080/home/teacherImg/${userCollectTeacher.teacher.teacherImg }"></td>
					<td>${userCollectTeacher.teacher.teacherIntro }</td>
