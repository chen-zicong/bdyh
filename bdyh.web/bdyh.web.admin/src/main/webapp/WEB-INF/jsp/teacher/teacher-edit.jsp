...
<article class="page-container">
	<form action="${pageContext.request.contextPath}/teacher/teacherAdd" class="form form-horizontal" id="form-teacher-add" method="POST">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${teacher.teacherName }" placeholder="" id="teacherName" name="teacherName">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${teacher.telephone }" placeholder="" id="telephone" name="telephone">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>邮箱：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="@" name="email" id="email" value="${teacher.email }">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>主讲：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${teacher.major }" placeholder="" id="major" name="major">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="teacherIntro" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" onKeyUp="$.Huitextarealength(this,100)">${teacher.teacherIntro }</textarea>
...
$(function(){
	...
	$("#form-teacher-add").validate({
		...
		submitHandler:function(form){
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/teacher/teacherEdit",
				type : "post",
				data : fd,
				dataType : "json",
				processData : false, // 告诉jQuery不要去处理发送的数据
