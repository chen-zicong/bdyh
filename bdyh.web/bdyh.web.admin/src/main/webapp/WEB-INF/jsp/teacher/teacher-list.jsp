		...
		<tbody>
			<c:forEach items="${teacherList }" var="teacher">
				<tr class="text-c">
					...
					<th><u style="cursor:pointer" class="text-primary" onclick="member_show('${teacher.teacherName }','${pageContext.request.contextPath}/teacher/teacherShow/${teacher.teacherId }','10001','360','400')">${teacher.teacherName }</u></th>
					<td>
						<c:choose>
							<c:when test="${teacher.sex eq 1 }">男</c:when>
							<c:otherwise>女</c:otherwise>
						</c:choose>
					</td>
					<td>${teacher.telephone }</td>
					<td>${teacher.email }</td>
					<td class="text-l">${teacher.teacherIntro }</td>
					...
					<c:if test="${teacher.status eq 1 }">
						<td class="td-manage"><a style="text-decoration:none" onClick="teacher_stop(this,'${teacher.teacherId}')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> <a title="编辑"  onclick="teacher_edit('编辑','${pageContext.request.contextPath}/teacher/teacherEditPage/${teacher.teacherId }','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="change_password('修改密码','${pageContext.request.contextPath}/teacher/changePasswordPage/${teacher.teacherId }','10001','600','270')" href="javascript:;" title="修改密码"><i class="Hui-iconfont">&#xe63f;</i></a> <a title="删除" href="javascript:;" onclick="teacher_del(this,'${teacher.teacherId}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
					</c:if>
					<c:if test="${teacher.status eq 0 }">
						<td class="td-manage"><a style="text-decoration:none" onClick="teacher_start(this,'${teacher.teacherId}')" href="javascript:;" title="启用"><i class="Hui-iconfont">&#xe6e1;</i></a> <a title="编辑"  onclick="teacher_edit('编辑','${pageContext.request.contextPath}/teacher/teacherEditPage/${teacher.teacherId }','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="change_password('修改密码','${pageContext.request.contextPath}/teacher/changePasswordPage/${teacher.teacherId }','10001','600','270')" href="javascript:;" title="修改密码"><i class="Hui-iconfont">&#xe63f;</i></a> <a title="删除" href="javascript:;" onclick="teacher_del(this,'${teacher.teacherId}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
					</c:if>
				</tr>
			</c:forEach>
		</tbody>
...
function teacher_stop(obj,id){
	...
	$.ajax({
		   type: "POST",
		   url: "${pageContext.request.contextPath}/teacher/teacherStop",
		   data: {
			   teacherId:id,
		   },
		   success: function(data){
				var data = eval('(' + data + ')');
				if (data.status==1){
					$(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" onClick="teacher_start(this,'+id+')" href="javascript:;" title="启用"><i class="Hui-iconfont">&#xe6e1;</i></a>');
...
function teacher_start(obj,id){
	...
	layer.confirm('确认要启用吗？',function(index){
		$.ajax({
		   type: "POST",
		   url: "${pageContext.request.contextPath}/teacher/teacherStart",
		   data: {
			   teacherId:id,
		   },
		   success: function(data){
				var data = eval('(' + data + ')');
				if (data.status==1){
					$(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" onClick="teacher_stop(this,'+id+')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a>');
...
function teacher_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
		   type: "POST",
		   url: "${pageContext.request.contextPath}/teacher/teacherDelete",
		   data: {
			   teacherId:id,
		   },
		   success: function(data){
