...
<script type="text/javascript">
	function courseSaveSubmit(){
		var fd = new FormData($("#form-article-add")[0]);
		
		$.ajax({
			url : "${pageContext.request.contextPath}/course/courseUpdate",
			type : "POST",
			data : fd,
			dataType : "json",
...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" >
		...
		<input hidden="hidden" name="courseId" value="${course.courseId }">
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>课程名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${course.courseName }" placeholder="请输入课程名" id="courseName" name="courseName">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box">
					<select name="courseLevel" class="select" id="courseLevel">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box">
				<select name="courseDifficulty" class="select" id="courseDifficulty">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${course.lessionNum }" placeholder="请输入视频的个数哦" id="lessionNum" name="lessionNum">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">课程价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${course.coursePrice }" placeholder="请输入课程的价格哦" id="coursePrice" name="coursePrice">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">课程介绍：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="courseDesc" id="courseDesc" cols="3" rows="80" class="textarea" placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)">${course.courseDesc }</textarea>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				...
				<button onClick="courseSaveSubmit();" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 保存并提交审核</button>
...
(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: '${pageContext.request.contextPath}/course/uploadPicture/${course.courseId}',
            //server: 'lib/webuploader/0.1.5/server/fileupload.php',
            // runtimeOrder: 'flash',
