	...
	<form class="form form-horizontal" id="valid">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" value=""  autocomplete="off" placeholder="请输入课程价格" id="videoPrice" name="videoPrice">￥
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">课程名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" autocomplete="off"  placeholder="请输入课程名称" id="videoName" name="videoName">
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<input class="btn btn-primary radius" type="submit"  id= "define" value="&nbsp;&nbsp;确定&nbsp;&nbsp;"><span style="color: red">(校验成功后即可上传视频)</span>
			</div>
		</div>
	</form>
