			...
			<tbody>
				<c:forEach items="${courseList }" var="course">
					<tr class="text-c">
						...
						<td><a href="javascript:;" onClick="course_edit('查看该课程','${pageContext.request.contextPath}/course/courseVideo/${course.courseId }','10001')"><img width="210" height="150" class="picture-thumb" src="http://bdpak.cn:8080/home/courseImg/${course.courseImg }"></a></td>
						...
						<c:choose>
							<c:when test="${course.status eq 2 }">
								<td class="td-manage"><a style="text-decoration:none" onClick="course_stop(this,'${course.courseId }')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> <a style="text-decoration:none" class="ml-5" onClick="course_edit('课程编辑','${pageContext.request.contextPath}/course/courseEditPage/${course.courseId}','${course.courseId }')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="course_del(this,'${course.courseId }')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
							</c:when>
							<c:when test="${course.status eq 1 }">
								<td class="td-manage"><a style="text-decoration:none" onClick="course_stop(this,'${course.courseId }')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> <a style="text-decoration:none" class="ml-5" onClick="course_edit('课程编辑','${pageContext.request.contextPath}/course/courseEditPage/${course.courseId}','${course.courseId }')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="course_del(this,'${course.courseId }')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
							</c:when>
							<c:otherwise>
								<td class="td-manage"><a style="text-decoration:none" onClick="course_shengqing(this,'${course.courseId }')" href="javascript:;" title="发布"><i class="Hui-iconfont">&#xe603;</i></a> <a style="text-decoration:none" class="ml-5" onClick="course_edit('课程编辑','${pageContext.request.contextPath}/course/courseEditPage/${course.courseId}','${course.courseId }')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="course_del(this,'${course.courseId }')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
							</c:otherwise>
						</c:choose>
...
function course_stop(obj,id){
	...
	$.ajax({
		   type: "GET",
		   url: "${pageContext.request.contextPath}/course/courseLayDown",
		   data: {
			   courseId:id,
		   },
		   success: function(data){
				...
				if (data.status==1){
					layer.confirm('确认要下架吗？',function(index){
						$(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" onClick="course_shengqing(this,'+id+')" href="javascript:;" title="发布"><i class="Hui-iconfont">&#xe603;</i></a>');
