			...
			<c:forEach items="${videoList }" var="video">
				<li class="item">
					<div class="portfoliobox">
						...
						<div class="picbox "><a href="${pageContext.request.contextPath}/video/playVideo/${video.videoPath}" data-lightbox="gallery" data-title="${video.videoName }"><img src="http://bdpak.cn:8080/home/courseImg/${video.videoImg }"></a></div>
