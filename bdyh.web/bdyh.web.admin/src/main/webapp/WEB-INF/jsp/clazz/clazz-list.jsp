				...
				<c:forEach items="${clazzList }" var="clazz">
					<tr class="text-c">
						...
						<c:choose>
							<c:when test="${clazz.status eq 1 }">
								<td class="td-manage">
									<a style="text-decoration:none" onClick="clazz_stop(this,'${clazz.clazzId }')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a>
								</td>
							</c:when>
							<c:otherwise>
								<td class="td-manage">
									<a style="text-decoration:none" onClick="clazz_start(this,'${clazz.clazzId }')" href="javascript:;" title="发布"><i class="Hui-iconfont">&#xe603;</i></a>
								</td>
							</c:otherwise>
						</c:choose>
					</tr>
