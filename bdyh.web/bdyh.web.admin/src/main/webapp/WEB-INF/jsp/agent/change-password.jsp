...
<article class="page-container">
	<form action="/" method="post" class="form form-horizontal" id="form-change-password">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> ${agent.nickname } </div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>账户：</label>
			<div class="formControls col-xs-8 col-sm-9"> ${agent.username } </div>
		</div>
		<div class="row cl">
...
$(function(){
	$("#form-change-password").validate({
		...
		submitHandler:function(form){
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/adminAgent/changePassword",
				type : "post",
				data : fd,
				dataType : "json",
