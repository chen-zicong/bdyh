...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
		...
		<a href="javascript:;" onclick="member_add('添加用户','${pageContext.request.contextPath}/adminAgent/agentAddPage','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加代理商</a></span> <span class="r">共有数据：<strong>${agentList.size() }</strong> 条</span> </div>
	<div class="mt-20">
