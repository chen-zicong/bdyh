...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 区域管理 <span class="c-gray en">&gt;</span> 城市列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-primary radius"><!-- <i class="Hui-iconfont">&#xe6e2;</i> --> 默认开通</a> </span> <span class="r">共有数据：<strong>${cityList.size() }</strong> 条</span> </div>
	<div class="mt-20">
				...
				<c:forEach items="${cityList }" var="city">
					<tr class="text-c">
						...
						<td>
							...
							<span class="label label-success radius"><a style="text-decoration:none" class="ml-5" onClick="member_edit('查看所有区域','${pageContext.request.contextPath}/district/districtList/${city.cityId }','${city.cityId }')" href="javascript:;" title="所有区域">查看所有区域</a></span>
						</td>
						<td class="td-status">
