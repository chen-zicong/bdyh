...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-primary radius"><!-- <i class="Hui-iconfont">&#xe6e2;</i> --> 默认开通</a> </span> <span class="r">共有数据：<strong>${districtList.size() }</strong> 条</span> </div>
	<div class="mt-20">
				...
				<c:forEach items="${districtList }" var="district">
					<tr class="text-c">
						...
						<%-- <td>
							...
							<span class="label label-success radius"><a style="text-decoration:none" class="ml-5" onClick="member_edit('查看所有科目','${pageContext.request.contextPath}/district/districtList/${district.districtId }','${district.districtId }')" href="javascript:;" title="所有城市">查看所有城市</a></span>
						</td> --%>
						<td class="td-status">
