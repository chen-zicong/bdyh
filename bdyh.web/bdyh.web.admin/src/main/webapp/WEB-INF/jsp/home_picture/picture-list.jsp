...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="picture_add('添加轮播图','${pageContext.request.contextPath}/picture/pictureAddPage')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加轮播图</a></span> <span class="r">共有数据：<strong>${homePictureList.size()}</strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <td><%-- <a href="javascript:;" onClick="course_edit('查看该课程','${pageContext.request.contextPath}/course/courseVideo/${course.courseId }','10001')"></a> --%><img width="210" height="150" class="picture-thumb " src="http://bdpak.cn:8080/home/home_picture/${picture.picturePath}"></td>
						...
						<c:choose>
							<c:when test="${picture.status eq 1 }">
								<td class="td-manage">
									<a style="text-decoration:none" onClick="picture_stop(this,'${picture.pictureId }')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> 
								    <a style="text-decoration:none" class="ml-5" onClick="picture_del(this,'${picture.pictureId }')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
								</td>
							</c:when>
							<c:otherwise>
								<td class="td-manage">
									<a style="text-decoration:none" onClick="picture_start(this,'${picture.pictureId }')" href="javascript:;" title="发布"><i class="Hui-iconfont">&#xe603;</i></a> 
									<a style="text-decoration:none" class="ml-5" onClick="picture_del(this,'${picture.pictureId }')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
								</td>
							</c:otherwise>
						</c:choose>
