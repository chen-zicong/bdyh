...
<link rel="stylesheet" href="${pageContext.request.contextPath}/node_modules/zoomify/zoomify.css">
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 统计管理 <span class="c-gray en">&gt;</span> 收藏统计 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
			...
			<tbody>
				<c:forEach items="${courseList }" var="course">
					<tr class="text-c">
						...
						<th class="text-c">${course.courseName }</th>
						<td><img width="210" height="150" class="picture-thumb" src="http://bdpak.cn:8080/home/courseImg/${course.courseImg }"></td>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/node_modules/zoomify/zoomify.js"></script>
