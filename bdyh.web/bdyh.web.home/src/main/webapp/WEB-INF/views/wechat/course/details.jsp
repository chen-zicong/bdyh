						...
						<div data-am-widget="list_news" class="am-list-news am-list-news-default"
							...
							<div class="am-list-news-bd course-list">
								<ul class="am-list" style="font-size:14px;">
									<c:forEach items="${videoList }" var="video">
										<li class="am-g am-list-item-dated">					
											<a href="javaScript:playVideo('${video.videoPath}')" class="am-list-item-hd lesson-catalog-list">
												<%--<a href="javaScript:pay()" class="am-list-item-hd lesson-catalog-list">--%>
									...
									<!-- <li class="am-g am-list-item-dated">
										<a href="javaScript:playVideo(2)" class="am-list-item-hd lesson-catalog-list">
										<i style="font-size:15px;margin-left:5px;" class="iconfont icon-bofang"></i>
										<span>第一单第二节圆的周长(免费)</span>
										</a> 
									</li>
									<li class="am-g am-list-item-dated">
										<a href="javaScript:playVideo(1)" class="am-list-item-hd lesson-catalog-list">
										<i style="font-size:15px;margin-left:5px;" class="iconfont icon-bofang"></i>
										<span>第一单第三节圆的面积
											<span style="color:green;">(免费试听)</span>
										</span>
										</a> 
									</li>
									<li class="am-g am-list-item-dated">
										...
										<i style="font-size:15px;margin-left:5px;" class="iconfont icon-bofang"></i>
										<span>第一单第三节圆的面积
											<span style="color:red;">(付费10元)</span>
										</span>
										</a> 
									</li> -->
								</ul>
...
<script>
	...
	function playVideo(obj) {
		/* if (obj == 1) {
			$("#example_video_source").attr("src","${pageContext.request.contextPath}/demo/ceshi.mp4");
			$("#example_video_1_html5_api").attr("src","${pageContext.request.contextPath}/demo/ceshi.mp4");
		} else if (obj == 2) {
			$("#example_video_source").attr("src","${pageContext.request.contextPath}/demo/shuxue.mp4");
			$("#example_video_1_html5_api").attr("src","${pageContext.request.contextPath}/demo/shuxue.mp4");
		} else {
			$("#example_video_source").attr("src","${pageContext.request.contextPath}/demo/six_grade_math.mp4");
			$("#example_video_1_html5_api").attr("src","${pageContext.request.contextPath}/demo/six_grade_math.mp4");
		} */
		
		/*使用nginx时候把${pageContext.request.contextPath}替换成http://localhost:8080/video/obj*/
		if(obj.toString().trim()!=null){
			var path=obj.toString();
			$("#example_video_source").attr("src","http://bdpak.cn:8080/home/video/"+path);
