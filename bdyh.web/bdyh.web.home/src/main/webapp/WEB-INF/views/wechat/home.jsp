...
<body>
	...
	<div class="bdyh_mian">
		<!-- slider start -->
		<div id="your-slider" data-am-widget="slider"  class="am-slider am-slider-default" data-am-slider='{&quot;animation&quot;:&quot;slide&quot;,&quot;slideshow&quot;:false;playAfterPaused:3000}' >
			<ul class="am-slides">
		...
		<div class="bdyh_news_content_main">
			<div data-am-widget="list_news" class="am-list-news am-list-news-default" >
				...
				<div class="am-list-news-hd am-cf">
				   ...
				   <a href="${pageContext.request.contextPath}/course/moreLesson" class="am-fr" style="display:inline-block;">
			...
			<div class="am-offcanvas-bar" style="width:220px;">
				<div class="am-offcanvas-content">
					...
					<ul class="am-list admin-sidebar-list" id="collapase-nav-1">
						<li class="am-panel">
						  <a href="${pageContext.request.contextPath}/course/lessonListLevel/7">
						      <i style="color:#00BFFF;font-size:20px;line-height:20px;" class="iconfont icon-jihe5"></i>(七年级)
						...
						<li class="am-panel">
						  <a href="${pageContext.request.contextPath}/course/lessonListLevel/9">
						      <i style="color:#00BFFF;font-size:20px;line-height:20px;" class="iconfont icon-chusanfuxi"></i>(九年级)
						      <i class="am-icon-angle-right am-fr am-margin-right"></i>
						  </a>
						</li>
						<li class="am-panel">
						  <a href="${pageContext.request.contextPath}/course/lessonListLevel/10">
						      <i style="color:#00BFFF;font-size:20px;line-height:20px;" class="iconfont icon-gaoyitongbu"></i>(高一)
						      <i class="am-icon-angle-right am-fr am-margin-right"></i>
						  </a>
						</li>
						<li class="am-panel">
						  <a href="${pageContext.request.contextPath}/course/lessonListLevel/11">
						      <i style="color:#00BFFF;font-size:20px;line-height:20px;" class="iconfont icon-gaoertifen"></i>(高二)
						      <i class="am-icon-angle-right am-fr am-margin-right"></i>
						  </a>
						</li>
						<li class="am-panel">
						  <a href="${pageContext.request.contextPath}/course/lessonListLevel/12">
						      <i style="color:#00BFFF;font-size:20px;line-height:20px;" class="iconfont icon-gaosanchongci"></i>(高三)
						      <i class="am-icon-angle-right am-fr am-margin-right"></i>
						  </a>
						</li>
					</ul>
